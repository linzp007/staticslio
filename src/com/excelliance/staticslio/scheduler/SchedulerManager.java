 ...
 * @author liuyuli
 *
 * 2016年7月20日上午11:29:03 
 */
public class SchedulerManager {
	private static final String ACTION_SCHEDULER_MANAGER = "com.action.broadreceiver.schedulermanager";
	...
	public void executeTask(SchedulerTask task) {
		...
		try {
		    ...
		    if (UtilTool.isEnableLog()) {
                UtilTool.logStatic("executeTask error:"+e.getMessage());
            }
		}
	}
